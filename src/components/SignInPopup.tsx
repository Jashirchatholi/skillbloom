              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-8 shadow-xl transition-all">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    />
                    {isSignIn && (
                      <a href="#" className="text-sm text-blue-600 hover:text-blue-700 mt-1 block">
                        Forgot password?
                      </a>
                    )}
                  </div>
                  ...
                  <div className="text-center text-sm">
                    <span className="text-gray-600">
                      {isSignIn ? 'New to Coursera? ' : 'Already on Coursera? '}
                    </span>
                    <button 
                      onClick={switchForm}
                      type="button"
                  ...
                  <p className="text-xs text-gray-500 text-center mt-4">
                    {!isSignIn && 'I accept Coursera\'s '}
                    This site is protected by reCAPTCHA Enterprise and the Google{' '}
                    <a href="#" className="text-gray-700">Privacy Policy</a> and{' '}
                    <a href="#" className="text-gray-700">Terms of Service</a> apply.
                  </p>
                </form>
              </Dialog.Panel>
            </Transition.Child>
